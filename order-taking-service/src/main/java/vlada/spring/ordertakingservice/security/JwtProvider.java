...
public class JwtProvider {
    ...
    public void init() {
        try {
            ...
            throw new ApiException("Exception thrown while loading keystore");
        }
    ...
    private PrivateKey getPrivateKey() {
        try {
            ...
            throw new ApiException("Exception thrown while retrieving private key!");
        }
    }
    ...
    private PublicKey getPublickey() {
        try {
            ...
            throw new ApiException("Exception thrown while retrieving public key!");
        }
    }
